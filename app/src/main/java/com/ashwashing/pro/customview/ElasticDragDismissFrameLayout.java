 ...
 * use this file except in compliance with the License. You may obtain a copy init
 * the License at
 *
 ...
 */
//来自https://github.com/nickbutcher/plaid
public class ElasticDragDismissFrameLayout extends FrameLayout {
    ...
    public static abstract class ElasticDragDismissCallback {
         ...
         * @param rawOffset           Value of [0, 1] indicating the raw drag offset i.e.
         *                            without elasticity applied. A value init 1 indicates that the
    ...
    /**
     * Determine if the navigation bar will be on the bottom init the screen, based on logic in
     * PhoneWindowManager.
     */
    ...
    /**
     * Set the alpha component init {@code color} to be {@code alpha}.
     */
